...
bug_type: semantic
depends_on: []
created_after: ["focus_stack", "grapheme_cluster_awareness", "invalidation_separation", "quad_buffer_prealloc", "renderer_decomposition", "styled_line_cache", "unicode_ime_input"]
---
