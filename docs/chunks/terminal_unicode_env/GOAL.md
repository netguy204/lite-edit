...
code_references:
  - ref: crates/terminal/src/pty.rs#configure_pty_environment
    implements: "UTF-8 locale detection and environment variable setup for PTY child processes"
  - ref: crates/terminal/src/pty.rs#tests::test_env_lang_utf8
    implements: "Test verifying LANG environment variable contains UTF-8"
  - ref: crates/terminal/src/pty.rs#tests::test_env_term_program
    implements: "Test verifying TERM_PROGRAM is set to lite-edit"
  - ref: crates/terminal/src/pty.rs#tests::test_unicode_output_preserved
    implements: "Regression test verifying Unicode characters pass through intact"
narrative: null
investigation: null
subsystems: []
friction_entries: []
